...
- **[event-command-service](https://github.com/Evently-Event-Management/event-command-service)**: Java/Spring Boot write model
- **[event-query-service](https://github.com/Evently-Event-Management/event-query-service)**: Java/Spring WebFlux read model with SSE
- **[order-service](https://github.com/Evently-Event-Management/order-service)**: Go order processing with Stripe integration
- **[scheduler-service](https://github.com/Evently-Event-Management/scheduler-service)**: Go scheduling and reminders
- **[web-app](https://github.com/Evently-Event-Management/web-app)**: Next.js frontend application
- **[mobile-checkin-app](https://github.com/Evently-Event-Management/mobile-checkin-app)**: React Native staff check-in app
